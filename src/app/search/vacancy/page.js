            ...
            <Header/>
                ...
                <div className='container mt7'>
                    ...
                    <div style={{width: `20%`}}> 
                        ...
                        {/* {isSpecModalOpen && <ModalSelectSpec close={closeModalExp} onChange={spec => setSpecialization(spec)}/>} */}
                        ...
                        <fieldset className="fieldset-vertical fieldset-md">
                            ...
                            <div className="input-group">
                                <input className="input" placeholder="От" type="text" value={salary_from} onChange={(e)=>setSalary(e.target.value)}/>
